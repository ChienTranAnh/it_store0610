<header class="app-header"><a class="app-header__logo" href="/trangchu" target="_blank">It store</a>
    ...
    <ul class="app-nav">
        ...
        <!-- User Menu-->
        @if(session('user'))
            <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu" title="{{session('user')->HoTen}}"><i class="fa fa-user fa-lg"></i>&nbsp;{{session('user')->UserName}}</a>

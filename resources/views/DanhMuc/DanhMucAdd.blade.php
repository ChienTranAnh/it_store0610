...
@section('thanhphan', 'Thêm mới danh mục sản phẩm')
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="Id" value="{{ $danhMucs->Id ?? '' }}" placeholder="Nhập mã danh mục mới">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" rows="3" name="MoTa" placeholder="Nhập vài thông tin về danh mục">{{ $danhMucs->MoTa ?? '' }}</textarea>
                            </div>
                        </div>
                    </div>

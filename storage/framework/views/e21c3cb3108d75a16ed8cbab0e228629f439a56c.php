<?php $__env->startSection('title', 'Thêm mới loại khách hàng'); ?>
<?php $__env->startSection('thanhphan', 'Thêm mới loại khách hàng'); ?>
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="Id" value="<?php echo e($loaiKHs->Id ?? ''); ?>" placeholder="Nhập mã loại khách hàng mới">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="LoaiKhachHang" value="<?php echo e($loaiKHs->LoaiKhachHang ?? ''); ?>" placeholder="Nhập loại khách hàng mới">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-md-1"></label>
...
<?php echo $__env->make('layoutsAd.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\IT_store0610\resources\views/loaikhachhang/loaiKHangadd.blade.php ENDPATH**/ ?>
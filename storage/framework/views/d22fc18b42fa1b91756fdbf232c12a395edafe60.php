<?php $__env->startSection('title', 'Sửa chủ đề'); ?>
<?php $__env->startSection('thanhphan', 'Sửa chủ đề'); ?>

<?php $__env->startSection('chude', 'is-expanded'); ?>

<?php $__env->startSection('content'); ?>
    <div class="col-md-12">
        <form method="POST" class="form-horizontal" action="/chude/sua/<?php echo e($chuDes->Id); ?>">
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="Id" value="<?php echo e($chuDes->Id ?? ''); ?>" disabled>
...
<?php echo $__env->make('layoutsAd.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\IT_store0610\resources\views/chude/chudeedit.blade.php ENDPATH**/ ?>
        ...
        <div class="login-box">
            <form class="login-form" role="form" action="<?php echo e(url('/dangnhap')); ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="UserName" value="<?php echo e($user->UserName??''); ?>" placeholder="Username" autofocus>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\IT_store0610\resources\views/dangnhap.blade.php ENDPATH**/ ?>
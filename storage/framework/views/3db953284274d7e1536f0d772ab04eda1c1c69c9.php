                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="Id" value="<?php echo e($danhMucs->Id ?? ''); ?>" placeholder="Nhập mã danh mục mới">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" rows="3" name="MoTa" placeholder="Nhập vài thông tin về danh mục"><?php echo e($danhMucs->MoTa ?? ''); ?></textarea>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layoutsAd.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\IT_store0610\resources\views/danhmuc/danhmucadd.blade.php ENDPATH**/ ?>